...
- [concepts/local-markdown-viewer.md](./concepts/local-markdown-viewer.md): low-intrusion attachment strategy for a Chrome-extension-like local markdown viewer using the existing browse route.
