...
- Local markdown viewing can be attached with low intrusion by special-casing markdown files in the existing `/codex-local-browse/*` server route.
...
- [Local markdown viewer concept](../concepts/local-markdown-viewer.md)
